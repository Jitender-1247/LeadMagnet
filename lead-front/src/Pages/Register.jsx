            ...
            <div className='relative z-10'>
              ...
              <div className="space-y-4 mt-12">
                <div className="flex items-center gap-4 text-gray-200 font-mono text-lg">
                  <ZapIcon className="text-emerald-400 w-5 h-7" /><span>Human Behavior Simulation</span>
                </div>
                <div className="flex items-center gap-4 text-gray-200 font-mono text-lg">
                  <Globe2Icon className="text-emerald-400 w-5 h-7" /><span>Dedicated Residential Proxy</span>
                </div>
                <div className="flex items-center gap-4 text-gray-200 font-mono text-lg">
                  <Inbox className="text-emerald-400 w-5 h-7" /><span>Centralized Lead Inbox</span>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center bg-[#302a2a] border border-gray-700 rounded-xl px-3">
                  ...
                  <input type="text" placeholder="Full Name" value={name}
                    ...
                    className="bg-transparent w-full text-white p-3 outline-none" required />
                </div>
                ...
                <button type="submit"
                  ...
                  className={`w-full font-bold py-3 rounded-xl transition text-white ${
                    loading ? 'bg-emerald-700 cursor-not-allowed'
                    : password !== confirmPassword ? 'bg-emerald-500 opacity-50 cursor-not-allowed'
